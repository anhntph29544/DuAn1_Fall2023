...
<div class="container">
    ...
    <form:form action="/hinh-anh/add" modelAttribute="hinhAnh" method="post" class="mb-4">
    ...
    <table class="table">
        ...
        <c:forEach items="${list}" var="gd">
            <tr>
                ...
                <td>
                    <a href="/hinh-anh/delete/${gd.id}" class="btn btn-danger">
                        Xóa
                    </a>
                    <a href="/hinh-anh/detail/${gd.id}" class="btn btn-primary">
                        Chi tiết
                    </a>
                </td>
            </tr>
